...
library(sp)
library(rgdal)
roads<-readOGR(dsn="C:/Users/God/Documents/ML",layer="carreteras",encoding="UTF-8")
class(roads)
...
writeOGR(roads,dsn="C:/Users/God/Documents/ML",layer="test",driver="ESRI Shapefile",overwrite=TRUE)
list.files("C:/Users/God/Documents/ML")
...
Creating a shapefile of polygons is slightly more complex and requires a couple more steps. We can use pipes from the **magrittr** package to make this easier. To close a polygon, the last point of the matrix needs to be the first point that starts the polygon.
...
```{r ex1sol, out.width="60%", echo=TRUE, include=TRUE}
...
# x is a list and a tibble so it needs to be transformed to a data frame before turning it to a spatial object
x<-as.data.frame(x$data)
