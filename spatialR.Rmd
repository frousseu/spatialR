...
```{r ex0sol, echo=TRUE, tidy=FALSE, out.width="60%"}
...
```{r exAsol, out.width="60%", echo=TRUE, include=TRUE, fig.height=5, fig.width=5}
...
buff<-gBuffer(bick,byid=TRUE,width=0.025)
plot(r)
plot(buff,add=TRUE)
