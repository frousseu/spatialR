...
Get data for *Trillium cernuum* using package `rgbif` and calculate the mean annual temperature and annual precipitation in the speices range. [Bioclimatic variables](http://worldclim.org/bioclim) are described in the WorldClim pages.
...
```{r ex2sol, out.width="100%", dev.args=list(pointsize=9)}
...
r<-raster::getData('worldclim',var='tmean',res=0.5,lon=-71,lat=45)
