...
s <- lengths(st_intersects(trille, outaouais))
...
```{r points_op2, fig.width = 7, fig.height = 6, out.width="80%"}
...
First, let's create two polygons with buffers arround some Red Trillium observations.
...
```{r polygons_op2, fig.width=7, fig.height=6, out.width = "100%"}
...
r1 <- rast("/home/frousseu/Documents/github/spatialR/data/cdem_dem_031G.tif")
r2 <- rast("/home/frousseu/Documents/github/spatialR/data/cdem_dem_031F.tif")
...
## Projecting
```{r stack3, out.width="90%",fig.height=5, fig.width=7}
...
plot(st_geometry(st_transform(trille, st_crs(r))), add = TRUE)
