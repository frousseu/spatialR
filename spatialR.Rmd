...
options(width=80)
knitr::opts_chunk$set(cache=TRUE,comment="##",eval=TRUE,error=TRUE,echo=TRUE,message=FALSE,warning=FALSE,tidy=TRUE,size="small",fig.align="center",out.width="100%")
...
r<-raster::getData('worldclim',var='bio',res=0.5,lon=-70,lat=45)
plot(r)
